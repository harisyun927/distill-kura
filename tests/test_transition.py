...
# When the store's OWN slugs are built out of other slugs, the closed template's
# alternation can read one line two ways: `x はやめて、y はやめて、z に統合する。` is
# both (old=x, new="y はやめて、z") and (old="x はやめて、y", new=z). Neither reading
# may win silently.
